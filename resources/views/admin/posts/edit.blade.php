...
<form action="{{route('admin.posts.update', $post )}}" method="POST">
  ...
  <div class="mb-4">
    ...
    <x-input class="w-full" placeholder="slug" name="slug"
     value="{{old('slug', $post->slug)}}"></x-input>
</div>
...
<x-textarea class="w-full" rows="12" name="body"> {{old('body', $post->body)}} </x-textarea>
